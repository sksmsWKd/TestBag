...
public class PingPongGame2 extends JPanel implements KeyListener{
	...
	class Ball{
		...
		public Ball (PingPongGame2 game , Color color) {
			this.game= game;
			this.color = color;
...
//			return r1c || r2c;  // 둘중 하나라도 트루면 트루다
	...
	class Racquet {
		...
		public Racquet(PingPongGame2 game, int x, int y, Color color,int s) {
			this.game=game;
			this.x = x;
			this.y= y;
			this.color = color;
...
public static void main (String [] args) {
	...
	PingPongGame2 panel = new PingPongGame2();
	frame.add(panel);
